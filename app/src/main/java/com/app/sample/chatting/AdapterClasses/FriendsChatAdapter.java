...
public class FriendsChatAdapter extends BaseAdapter {
    ...
    private int userId;
     com.app.sample.chatting.AsyncTaskClasses.FriendChatMessageStatusAsyncTask messagestatus=new com.app.sample.chatting.AsyncTaskClasses.FriendChatMessageStatusAsyncTask();
