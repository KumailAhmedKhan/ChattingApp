...
public class UserNotificationAsyncTask extends AsyncTask<String,String,Integer>
{
    ...
    String UserId;
    public UserNotificationAsyncTask(){

    }

    public UserNotificationAsyncTask(Context ctx) {
    ...
    protected void onPostExecute(Integer integer) {
        ...
        TimerTask task=new TimerTask() {
            ...
            public void run() {
                ...
                intent.putExtra("NotificationCounter",noti);
