...
public class SendFriendRequestAsyncTask extends AsyncTask<String,String,Boolean>
{
    ...
    public SendFriendRequestAsyncTask(Context ctx,Intent in,View vi) {
    ...
    public SendFriendRequestAsyncTask() {
    }
    ...
    protected Boolean doInBackground(String... strings)
    {
        ...
        if(checkconnectionflag==1)
        {
            ...
            try
            {
                ...
                ReceiverID=user2id;
                URL myUrl = new URL(Url + "/SendFrienRequest?senderId="+UserId+"&RecieverId="+user2id);
                //Create a connection
    ...
    protected void onPostExecute(Boolean s) {
        if(s){
            ...
            connection.invoke("sendFriendRequestAsync",conid,ReceiverID);
            ...
            //FriendShipStatus.setText("Cancel Friend Request");
            /*FriendShipStatus.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Id= String.valueOf(UserId);
                    RId= String.valueOf(ReceiverID);
                    cancelFriendRequestAsyncTask=(CancelFriendRequestAsyncTask) new CancelFriendRequestAsyncTask(context,view).execute(Id,RId);
                }
            });*/
